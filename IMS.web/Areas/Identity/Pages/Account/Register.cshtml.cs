...
namespace IMS.web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string storeId, string profileUrl, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                int StoreId = Input.StoreId;
                user.StoreId = storeId;
                user.UserRoleId = Input.UserRoleId;
                bool ProfileUrl = Input.ProfileUrl;
                user.ProfileUrl = profileUrl;
                user.IsActive = true;
                user.CreatedDate = Input.CreatedDate;
                user.Createdby = Input.Createdby;
                DateTime modifiedDate = Input.ModifiedDate;
                user.ModifiedDate = Input.modifiedDate;
